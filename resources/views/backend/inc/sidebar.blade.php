                    ...
                    <template x-if="isUserMenuOpen">
                        <ul x-transition:enter="transition-all ease-in-out duration-300"
                            ...
                            <li
                                ...
                                <a class="w-full" href="{{ route('get.user.list') }}">Users</a>
                            </li>
                            <li
                                class="px-2 py-1 transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200">
                                <a class="w-full" href="{{ route('get.vendor.list') }}">
                                    Vendors
                                </a>
                            </li>
                            {{-- <li
                                class="px-2 py-1 transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200">
                                <a class="w-full" href="{{ route('get.vendor.form') }}">
                                    Create Vendors
                                </a>
                            </li> --}}
                            ...
                            <li
                                class="px-2 py-1 transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200">
                                <a class="w-full" href="{{ route('vendor.request.list') }}">
                                    Vendor Requests
                                </a>
                            </li>
                            ...
                            <li
                                class="px-2 py-1 transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200">
                                <a class="w-full" href="{{ route('testimonial') }}">
                                    Testimonial
                                </a>
                            </li>
            ...
            <li class="relative px-6 py-3">
                ...
                <template x-if="isPagesMenuOpen">
                    <ul x-transition:enter="transition-all ease-in-out duration-300"
                        ...
                        <li
                            class="px-2 py-1 transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200">
                            <a class="w-full" href="{{route('my.events')}}">Participants</a>
                        </li>
