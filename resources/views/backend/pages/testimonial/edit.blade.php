    ...
    <div class="container px-6 mx-auto grid">
        ...
        <div class="w-full overflow-hidden rounded-lg shadow-xs">
            ...
            <form class="w-full p-10 mx-auto" action="{{route('manage.testimonial')}}" method="POST" enctype="multipart/form-data">
                ...
                <input type="hidden" name="testemonial_id" value="{{$data->id}}">
                <div class="flex flex-wrap -mx-3 mb-6">
                    <x-inline-form-input label="Name" value="{{$data->name}}" required="*" type="text" name="name"/>
                    <x-inline-form-input label="Designation" value="{{$data->designation}}" required="*"  type="text" name="designation"/>
                </div>

                <div class="flex flex-wrap -mx-3 mb-6">
                    <x-form-input label="Profile" name="thumbnail" required="*" value="{{$data->thumbnail}}" type="file"/>
                </div>
