...
<main class="h-full overflow-y-auto">
    <div class="container px-6 mx-auto grid">
        ...
        <div
            ...
            <span><a href="{{route('category')}}">Category &RightArrow;</a></span>
        </div>
        ...
        <div class="w-full overflow-hidden rounded-lg shadow-xs">
            ...
            <form class="w-full p-10 mx-auto" action="{{route('manage.category')}}" method="POST">
                @csrf
                <div class="flex flex-wrap -mx-3 mb-6">
                    <x-form-input label="Category" value="{{old('category_title')}}" required="*" type="text" name="category_title"/>
                </div>
